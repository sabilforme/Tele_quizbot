...
SYS_AR = (
    ...
    "حوّل النص التعليمي المرسل فقط (دون أي معلومات من خارج النص) إلى بنك أسئلة شامل يغطي كل ما فيه من مفاهيم وتعاريف وأمثلة وصيغ.\n"
    "اجعل الأسئلة بالعربية مع بقاء خيارات الإجابة باللغة الإنجليزية (خاصة المصطلحات).\n"
    "يجب أن تكون الأسئلة متنوعة الصعوبة (تذكر/فهم/تطبيق/تحليل) بحيث تغطي النص كاملاً بشكل يغني عن المذاكرة.\n"
...
PROMPT_AR = (
    "حوّل النص التالي إلى مجموعة كبيرة من أسئلة الامتحان اعتماداً حصرياً على محتوى النص. المتطلبات:\n"
    "- النوعان المدعومان: 'mcq' و 'tf'.\n"
    "- MCQ: أربعة خيارات قوية ومُلبِّسة، واحدة صحيحة فقط. الخيارات يجب أن تكون باللغة الإنجليزية فقط.\n"
    "- TF: الخيارات يجب أن تكون ['True/صح','False/خطأ'] وصياغة العبارات مأخوذة فقط من النص المرسل.\n"
    "- غطِّ جميع النقاط والمفاهيم المذكورة في النص دون أي إضافة خارجية.\n"
    "- اجعل الأسئلة متنوعة الصعوبة وتشمل مفاهيم مترابطة وربط بين الأفكار.\n"
    "- الناتج يجب أن يكون JSON Array فقط بالشكل:\n"
