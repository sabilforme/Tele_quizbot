...
SYS_AR = (
    ...
    "حوّل النص التعليمي إلى بنك أسئلة متنوع بمستويات صعوبة مختلفة (تذكر/فهم/تطبيق/تحليل) اريد ان تكون الاسئلة بالعربية مع  ابقاء المصطلحات بالإنجليزية اريد اكبر قدر ممكن من الأسئلة وايضا اريد ان تكون الاختيارات باللغة الانجليزية مثال(مصطلحات)بحيث ان يكون الاسئلة تغطي جميع المواضيع والنقاط والمفاهيم بشكل شامل تغني عن المذاكرة .\n"
